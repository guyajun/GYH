				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
							...
							<div class="modal fade" id="modal-measure-during">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											<form method="post" action="/GP/construct-web/curveMonitor.action" id="form-curve" class="form-horizontal" role="form">
												<div class="form-group">
						...
						<table class="table">
							<tbody>
								...
								<tr>
									<td id="aa">
										<s:property value="#monitor.dcIndx"/>
									</td>
									<td id="bb">
										<s:property value="#monitor.dcCdno"/>
									</td>
									<td id="cc">
										<s:property value="#monitor.dcTime"/>
									</td>
									<td id="dd">
										<s:property value="#monitor.dcValue"/>
									</td>
									<td id="ee">
										<s:property value="#monitor.dcVary"/>
									</td>
									<td id="ff">
										<s:property value="#soil.dcTotl"/>
									</td>
									<td id="gg">
										<s:property value="#monitor.dcX"/>
									</td>
									<td id="hh">
										<s:property value="#monitor.dcY"/>
									</td>
									<td id="ii">
										<s:property value="#monitor.dcJzwmaxlq"/>
									</td>
									<td id="jj">
										<s:property value="#monitor.dcJzwmaxcj"/>
									</td>
									<td id="kk">
										<s:property value="#monitor.dcGxmaxlq"/>
									</td>
									<td id="ll">
										<s:property value="#monitor.dcGxmaxcj"/>
									</td>
									<td id="mm">
										<s:property value="#monitor.isEast"/>
									</td>				
								</tr>
							</s:iterator>
						</tbody>
					...
					<div class="well">
						<div class="col-sm-offset-4">
							...
							<form id="form-page" method="post" action="/GP/construct-web/monitor_getAllRecord.action">
					<input id="input-page" name="pageNow" style="width:30px;" value="<s:property value="#page.pageNow"/>">
									/
									<s:property value="#page.totalPage"/>
								<s:if test="#page.hasFirst">
									<s:a target="_parent" href="/GP/construct-web/monitor_getAllRecord.action?pageNow=1">首页</s:a>
								</s:if>
								<s:if test="#page.hasPre">
									<a target="_parent" href="/GP/construct-web/monitor_getAllRecord.action?pageNow=<s:property value="#page.pageNow-1"/>
									">上一页
								</a>
							</s:if>
						...
						<s:if test="#page.hasLast">
							<a target="_parent" href="/GP/construct-web/monitor_getAllRecord.action?pageNow=<s:property value="#page.totalPage"/>
							">尾页
						</a>
					</s:if>
