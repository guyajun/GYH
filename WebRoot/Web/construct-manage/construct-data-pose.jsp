					...
					<div class="panel-body">
						<div class="well">
							<div class="btn-group">
								...
								<ul class="dropdown-menu" role="menu">
									<li><a href="#" data-toggle="modal"
										data-target="#modal-pose-loop">按环号查询</a></li>
									<li><a href="#" data-toggle="modal"
										data-target="#modal-pose-number">按项目编号查询</a></li>
								</ul>
							</div>
							<div class="modal fade" id="modal-pose-number">
								<div class="modal-dialog">
									<div class="modal-content">
									<form class="form-horizontal"  action="/GP/construct-web/number.action" role="form">
							...
							<div class="modal fade" id="modal-pose-loop">
								<div class="modal-dialog">
									<div class="modal-content">
									<form class="form-horizontal"  action="/GP/construct-web/getposeBytunnelLoop.action" role="form">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal"
												aria-hidden="true">&times;</button>
											<h4 class="modal-title" id="myModalLabel">盾构/管片姿态信息</h4>
										...
										<div class="modal-body">
												<div class="form-group">
													...
													<div class="col-sm-5 input-group">
														<input id="input-measure-loop" name="tunnelLoop" type="text" 
															class="form-control">
													</div>
												</div>
										</div>
						...
						<div class="btn-group">
							...
							<div class="btn-group">
								...
								<ul class="dropdown-menu" role="menu">
									<li><a href="#" data-toggle="modal"
										data-target="#modal-shield-vertical">盾构高程偏差曲线</a></li>
									<li><a href="#" data-toggle="modal"
										data-target="#modal-shield-horizontal">盾构平面偏差曲线</a></li>
									<li><a href="#" data-toggle="modal"
										data-target="#modal-gp-vertical">管片高程偏差曲线</a></li>
									<li><a href="#" data-toggle="modal"
										data-target="#modal-gp-horizontal">管片平面偏差曲线</a></li>
								</ul>
							</div>
							<div class="modal fade" id="modal-total">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											<div class="row">
												<form id="form-total" method="post" action="/GP/construct-web/excelAll5.action" class="form-inline" role="form">
													<div class="form-group col-sm-9">
														<label class="col-sm-6 control-label" for="excelPath">请输入EXCEL导出路径：</label>
														<div class="col-sm-6">
															<input id="excelPath" name="excelPath" value="d:/盾构和管片姿态信息.xls" type="text" class="form-control"></div>
													</div>
													<div class="col-sm-3">
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<form class="form-horizontal" role="form">
												<div class="form-group">
													<label class="col-sm-4 control-label"
														for="input-shield-horizontal-start-loop">起始环号：</label>
													<div class="col-sm-5 input-group">
												...
												<div class="form-group">
													<label class="col-sm-4 control-label"
														for="input-shield-horizontal-end-loop">结束环号：</label>
													<div class="col-sm-5 input-group">
														<input id="input-shield-horizontal-end-loop" type="text"
															class="form-control">
													</div>
												</div>
											</form>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<form class="form-horizontal" role="form">
												<div class="form-group">
													<label class="col-sm-4 control-label"
														for="input-gp-high-start-loop">起始环号：</label>
													<div class="col-sm-5 input-group">
														<input id="input-gp-high-start-loop" type="text"
															class="form-control">
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-4 control-label"
														for="input-gp-high-end-loop">结束环号：</label>
													<div class="col-sm-5 input-group">
														<input id="input-gp-high-end-loop" type="text"
															class="form-control">
													</div>
												</div>
											</form>
					...
					<table class="table">
						<tbody>
							<tr>
								...
								<tr>
									<td id="index"><s:property value="#pose.tunnelLoop" /></td>
									<td id="aa"><s:property value="#pose.proId" /></td>
									<td id="bb"><s:property value="#pose.designLinear" /></td>
									<td id="cc"><s:property value="#pose.designSlope" /></td>
									<td id="dd"><s:property value="#pose.shieldSlope" /></td>
									<td id="ee"><s:property value="#pose.rotateAngle" /></td>
									<td id="ff"><s:property value="#pose.incisionMileage" />
									</td>
									<td id="gg"><s:property value="#pose.shieldVerticalTwo" />
									</td>
									<td id="hh"><s:property value="#pose.shieldPlaneTwo" /></td>
