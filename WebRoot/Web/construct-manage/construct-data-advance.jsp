				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
						...
						<div class="btn-group">
							...
							<ul class="dropdown-menu" role="menu">
								<li><a href="/GP/construct-web/chartAdvance.action">按时间</a>
								</li>
								<!-- <li>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									<form id="form-loop-query" method="post"
										action="/GP/construct-web/advance_excelBetween.action"
									...
									<div class="modal-body">
										<div class="row">
											<form id="form-total" method="post"
												action="/GP/construct-web/excelAdvance.action"
						...
						<div class="modal fade" id="modal-advance-loop">
							<div class="modal-dialog">
								<div class="modal-content">
									<form class="form-inline" role="form" method="post"
										action="/GP/construct-web/advance_getByLoop.action">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal"
												aria-hidden="true">&times;</button>
											<h4 class="modal-title" id="myModalLabel">盾构推进信息查询</h4>
