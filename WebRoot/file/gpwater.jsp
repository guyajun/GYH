...
alert('here');
  ...
  <div style="margin:0px 0;"></div>
	<div class="easyui-panel" title="管片水养" style="width:auto">
	    ...
	    <th data-options="field:'reportId',width:110" align="center">报告编号</th>
	    ...
	    <th data-options="field:'produceDate',width:100" align="center">管片生产日期</th>
	     <th data-options="field:'inpoolTime',width:100" align="center">入池日期</th>
	    <th data-options="field:'segmentTem',width:100" align="center">管片温度</th>
	    <th data-options="field:'waterTem',width:100" align="center">水温</th>
	     <th data-options="field:'waterPh',width:80" align="center">PH值</th>
	      <th data-options="field:'outpoolTime',width:100" align="center">出池日期</th>
	        <th data-options="field:'recordWorker',width:100" align="center">记录人</th>
	    ...
	    <td><s:property value="#c2.id" /></td> 
	     ...
	     <td><s:property value="#c2.endNum" /></td>
	          ...
	          <td><s:property value="#c2.inpoolTime" /></td>
	          <td><s:property value="#c2.segmentTem" /></td>
	          <td><s:property value="#c2.waterTem" /></td>
	          <td><s:property value="#c2.waterPh" /></td>
	          <td><s:property value="#c2.outpoolTime" /></td>
	          <td><s:property value="#c2.recordWorker" /></td>
