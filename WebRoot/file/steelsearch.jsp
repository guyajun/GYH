...
alert('here');
  ...
  <div style="margin:10px 0;"></div>
	<div class="easyui-panel" title="钢筋原材料检测报告" style="width:auto">
	    ...
	    <th data-options="field:'reportId',width:100" align="center">报告编号</th>
	      <th data-options="field:'mapQualId',width:100" align="center">对应质量证明书编号</th>
	    <th data-options="field:'specification',width:100" align="center">钢筋规格</th>
	    <th data-options="field:'tensileStan',width:100" align="center">抗拉标准值</th>
	    <th data-options="field:'tensileValue',width:100" align="center">抗拉实测值</th>
	    <th data-options="field:'tensileIsQulified',width:100" align="center">是否合格</th>
	    ...
	    <td><s:property value="#c2.id" /></td> 
	     <td><s:property value="#c2.reportId" /></td>
	      <td><s:property value="#c2.mapQualId" /></td>
	      <td><s:property value="#c2.specification" /></td>
	       <td><s:property value="#c2.tensileStan" /></td>
	        <td><s:property value="#c2.tensileValue" /></td>
	         <td><s:property value="#c2.tensileIsQulified" /></td>
