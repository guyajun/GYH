...
alert('here');
  ...
  <div style="margin:10px 0;"></div>
	<div class="easyui-panel" title="管片检漏" style="width:auto">
	    ...
	    <th data-options="field:'isQualified',width:100" align="center">是否合格</th>
	     <th data-options="field:'checkWorker',width:100" align="center">质检人</th>
	    <th data-options="field:'supervisorWorker',width:100" align="center">监理人</th>
	     ...
	     <td><s:property value="#c2.reportId" /></td>
	        <td><s:property value="#c2.startNum" /></td>
	         <td><s:property value="#c2.endNum" /></td>
	          <td><s:property value="#c2.isQualified" /></td>
	          <td><s:property value="#c2.checkWorker" /></td>
	          <td><s:property value="#c2supervisorWorker" /></td>
