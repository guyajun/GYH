...
alert('here');
  ...
  <div style="margin:10px 0;"></div>
	<div class="easyui-panel" title="钢筋质量证明书" style="width:auto">
	    ...
	    <th data-options="field:'useBeginTime',width:100" align="center">开始使用日期</th>
	     <th data-options="field:'useEndTime',width:100" align="center">结束使用日期</th>
	    <th data-options="field:'purchaseAmount',width:100" align="center">进货数量</th>
	    <th data-options="field:'manufacture',width:100" align="center">生产厂家</th>
	    ...
	    <td><s:property value="#c2.id" /></td> 
	     <td><s:property value="#c2.reportId" /></td>
	      <td><s:property value="#c2.specification" /></td>
	       <td><s:property value="#c2.useBeginTime" /></td>
	        <td><s:property value="#c2.useEndTime" /></td>
	        <td><s:property value="#c2.purchaseAmount" /></td>
	         <td><s:property value="#c2.manufacturer" /></td>
