...
alert('here');
  ...
  <div style="margin:0px 0;"></div>
	<div class="easyui-panel" title="管片蒸养" style="width:auto">
	    ...
	    <th data-options="field:'produceDate',width:100" align="center">管片生产日期</th>
	     <th data-options="field:'moldNum',width:100" align="center">钢模编号</th>
	    <th data-options="field:'time',width:100" align="center">时间</th>
	    <th data-options="field:'temperature',width:100" align="center">温度</th>
	     ...
	     <td><s:property value="#c2.reportId" /></td>
	        <td><s:property value="#c2.startNum" /></td>
	         <td><s:property value="#c2.endNum" /></td>
	          ...
	          <td><s:property value="#c2.moldNum" /></td>
	          <td><s:property value="#c2.time" /></td>
	          <td><s:property value="#c2.temperature" /></td>
