...
alert('here');
  ...
  <div style="margin:10px 0;"></div>
	<div class="easyui-panel" title="管片仓储查询" style="width:auto">
	    ...
	    <th data-options="field:'storageArea',width:100" align="center">存放位置</th>
	    <th data-options="field:'storageDate',width:100" align="center">存放日期</th>
	    </tr>
	    </thead>
	    ...
	    <td><s:property value="#c2.coverId" /></td>
	     <td><s:property value="#c2.storageArea" /></td>
	     <td><s:property value="#c2.storageDate" /></td>
	          </tr>
	    </s:iterator>
	</table>
