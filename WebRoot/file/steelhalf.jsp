...
alert('here');
  ...
  <div style="margin:0px 0;"></div>
	<div class="easyui-panel" title="钢筋骨架半成品抽查" style="width:auto">
	    ...
	    <th data-options="field:'checkDate',width:100" align="center">抽查日期</th>
	     <th data-options="field:'checkResult',width:100" align="center">抽查结果</th>
	    <th data-options="field:'recordWorker',width:100" align="center">负责人</th>
	     ...
	     <td><s:property value="#c2.reportId" /></td>
	        <td><s:property value="#c2.startNum" /></td>
	         <td><s:property value="#c2.endNum" /></td>
	          <td><s:property value="#c2.checkDate" /></td>
	          <td><s:property value="#c2.checkResult" /></td>
