...
alert('here');
  ...
  <div style="margin:0px 0;"></div>
	<div class="easyui-panel" title="放松起吊通知单" style="width:auto">
	    ...
	    <th data-options="field:'produceDate',width:100" align="center">管片生产日期</th>
	     <th data-options="field:'moldNum',width:100" align="center">起吊日期</th>
	    <th data-options="field:'time',width:100" align="center">签发人</th>
	    <th data-options="field:'temperature',width:100" align="center">签发日期</th>
	    ...
	    <td><s:property value="#c2.id" /></td> 
	     <td><s:property value="#c2.reportId" /></td>
	          ...
	          <td><s:property value="#c2.craneTime" /></td>
	          <td><s:property value="#c2.signer" /></td>
	          <td><s:property value="#c2.signTime" /></td>
