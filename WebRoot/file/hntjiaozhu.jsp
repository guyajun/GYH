...
alert('here');
  ...
  <div style="margin:0px 0;"></div>
	<div class="easyui-panel" title="混凝土浇注" style="width:auto">
...
<!-- 	     <th data-options="field:'designStrength',width:100" align="center">设计强度</th>
	    <th data-options="field:'slumps',width:100" align="center">量测坍落度</th>
	    <th data-options="field:'concreteCount',width:100" align="center">混凝土完成数量</th>
	    <th data-options="field:'pourSituation',width:100" align="center">浇注情况</th>   -->
	    <th data-options="field:'responseWorker',width:100" align="center">负责人</th>
	    <th data-options="field:'recordWorker',width:100" align="center">填表人</th>
...
<!-- 	          <td><s:property value="#c2.designStrength" /></td>
	          <td><s:property value="#c2.slumps" /></td>
	          <td><s:property value="#c2.concreteCount" /></td>
	          <td><s:property value="#c2.pourSituation" /></td> -->
	          <td><s:property value="#c2.responseWorker" /></td>
