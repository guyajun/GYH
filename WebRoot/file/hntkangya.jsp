...
alert('here');
  ...
  <div style="margin:0px 0;"></div>
	<div class="easyui-panel" title="混凝土抗压" style="width:auto">
	    ...
	    <th data-options="field:'resistCompStan',width:100" align="center">标准值</th>
	    <th data-options="field:'resistCompValue',width:200" align="center">实测值</th>
	    <th data-options="field:'resistCompIsQual',width:100" align="center">是否合格</th>
	    ...
	    <td><s:property value="#c2.id" /></td> 
	     <td><s:property value="#c2.reportId" /></td>
	        <td><s:property value="#c2.resistCompStan" /></td>
	         <td><s:property value="#c2.resistCompValue" /></td>
	          <td><s:property value="#c2.resistCompIsQual" /></td>
