...
<link rel="stylesheet" type="text/css" href="../themes/default/easyui.css">
  ...
  <div style="margin:0px 0;"></div>
	<div class="easyui-panel" title="盾构和管片姿态报表" style="width:auto">
	    ...
	    <th data-options="field:'looker',width:100" align="center">观测者</th>
	    <th data-options="field:'ckecker',width:100" align="center">检测者</th>
	    <th data-options="field:'checkDate',width:100" align="center">观测时间</th>
