...
<link rel="stylesheet" type="text/css" href="../themes/default/easyui.css">
  ...
  <div style="margin:0px 0;"></div>
	<div class="easyui-panel" title="防水材料" style="width:auto">
	    ...
	    <th data-options="field:'url1',width:100" align="center">防水材料质保书</th>
	    <th data-options="field:'url2',width:100" align="center">防水材料检测报告</th>
	    <th data-options="field:'url3',width:100" align="center">防水材料检验报告</th>
	    </tr>
	    </thead>
	    ...
	    <td><s:property value="#c2.id" /></td> 
	     <td><s:property value="#c2.proId" /></td>
	         <td><a href="../constructuploadfile/<s:property value="#c2.url1" />" target="_blank"><s:property value="#c2.url1" /></a></td>
	          ...
	          <td><a href="../constructuploadfile/<s:property value="#c2.url3" />" target="_blank"><s:property value="#c2.url3" /></a></td>
	          </tr>
	    </s:iterator>
	</table>
