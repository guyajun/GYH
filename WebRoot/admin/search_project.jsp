		...
		<div class="easyui-panel" title="查询结果">
	     <table  border="1" cellspacing="1" cellpadding="8" width="900">
  		<tr align="center" bgcolor="white" height="30">
  			<th>项目名称</th><th>父项目名称</th><th>项目经理</th><th>生产单位</th><th>施工单位</th><th>详细</th>		
  		</tr>
		...
		<tr>
			<s:set name="page" value="#request.page"></s:set>
				...
				<s:if test="#page.hasNext">
					<a target="_parent" href="show_project?pageNow=<s:property value="#page.pageNow+1"/>">下一页</a>
				</s:if>
				<s:if test="#page.hasLast">
					<a target="_parent" href="show_project?pageNow=<s:property value="#page.totalPage"/>">尾页</a>
				</s:if>
		</tr>
