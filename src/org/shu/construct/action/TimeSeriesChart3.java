...
public class TimeSeriesChart3 extends BaseAction {
	...
	public String getTimeSeriesChart() throws Exception {
		...
		ChartUtilities.saveChartAsJPEG(new File("E:/workspace/.metadata/.me_tcat/webapps/GP/md.jpg"), jfreechart, 3000,
				500);
		return SUCCESS;
	...
	public XYDataset createDataset() {
		...
		TimeSeries timeseries = new TimeSeries("比重的变化曲纄1�7",
